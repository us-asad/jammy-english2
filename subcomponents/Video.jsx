  ...
  return (
    <div className="flex justify-center items-center relative">
      <div className="w-full group">
        ...
        {!playVideo && <span className="animate-ping absolute top-[46.5%] z-10 left-[48%] text-[23px] md:text-[38px] text-white customTransition w-12 h-12 md:w-[50px] md:h-[50px] bg-main rounded-full"></span>}
        <button
