...
export default function Contact() {
  return (
    <section id="contact" className="custom-banner relative">
      <h2 className="absolute top-[31px] md:top-[35px] w-full text-center text-[30px] leading-[39px] md:text-[56px] md:leading-[72.8px] font-semibold font-poppins text-main">
        {data.title}
      </h2>
      ...
      <div>
        <DecorationImg img={shape15} className="bottom-32 left-[5%]" />
      </div>
    </section>
  );
}